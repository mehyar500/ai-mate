...
- **97 Python / seven Node checks pass**, including short ambient-reply timing and credential-safe Gateway diagnostics. Two synthetic Chromium media checks passed captions, call/Text navigation, unmuted audio completion and ending calls. A prior real streaming cancellation completed in 0.328s, preserving conversation and the listening pose and removing cancelled media. Unmuted browser completion is not confirmation of physical speaker output.
