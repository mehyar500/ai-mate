...
Pin every deployed model/checkpoint/runtime revision, hash and license, including MuseTalk dependencies and voice phonemizers. Exclude XTTS-v2's noncommercial weights and unlicensed fine-tunes. No raw call recording; minimize proof/log retention; allow memory/account deletion. Keep AI disclosure, consent and reporting visible. Never promise the character is human or pressure payment through emotional dependency.
