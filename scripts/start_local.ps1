...
if ($Background) {
    ...
    $pocProcess = Start-Process -FilePath $pocPython -ArgumentList @('-u', '-m', 'local_app') -WorkingDirectory $projectRoot -WindowStyle Hidden -RedirectStandardOutput $pocOut -RedirectStandardError $pocErr -PassThru
