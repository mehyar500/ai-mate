...
**Current stage: a running, non-explicit local prototype on the founder's RTX 4060 Ti, 16GB VRAM and 48GB RAM.** Text, Voice call and Video call share conversation and memory. Calls use microphone input with mute/end controls; text entry has its own tab, which keeps an active call connected. The video fills the available height, retaining head-to-toe framing. Reviewed approach/return clips and listening loops support full-body and close views with newly generated speech/lips. Fresh movements still have uneven quality. Camera access is disabled. Public access and billing remain unqualified.
